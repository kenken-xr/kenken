...
<script>
    ...
    export default {
        ...
        methods: {
            animationOnChange: function(event) {
            ...
            disabledOnChange: function (event) {
                let value = event.args.checked;
            ...
            topLevelArrowsOnChange: function (event) {
                let value = event.args.checked;
