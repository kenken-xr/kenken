...
<script>
    import JqxForm from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxform.vue';
    import JqxTimePicker from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxtimepicker.vue';
