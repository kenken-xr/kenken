<template>
    <JqxSplitter ref="splitter"
        ...
        <div style="overflow: hidden;" ref="contentPanel">
        </div>
    </JqxSplitter>
</template>
<script>
    ...
    export default {
        ...
        mounted: function() {
            this.updatePanel(0);
            this.$refs.listbox.ensureVisible(0);
        },
        methods: {       
            ...
            updatePanel: function(index) {
                ...
                let listBoxItemValue = this.$refs.listbox.getItem(index).value;
                let education = '<div style="clear: both; margin: 10px;"><div><b>Education</b></div><div>' + listBoxItemValue + '</div></div>';
                container.innerHTML += education;
                this.$refs.contentPanel.innerHTML = container.innerHTML;
            },
