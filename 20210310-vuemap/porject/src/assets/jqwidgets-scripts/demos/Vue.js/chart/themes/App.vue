...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            selectionTemplate: function (element, index) {
                if (index < 0)
                    return;
                let colors = this.schemes[index].colors;
                let html = '';
            ...
            myDropDownListOnChange: function () {
                let selectedIndex = this.$refs.myList.selectedIndex;
                this.$refs.myChart.colorScheme = this.schemes[selectedIndex].name;
            }
        }
    };
</script>
