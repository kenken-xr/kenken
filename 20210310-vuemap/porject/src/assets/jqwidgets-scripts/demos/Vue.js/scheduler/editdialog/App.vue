<template>
    <JqxScheduler ref="myScheduler"
        ...
        :editDialogCreate="editDialogCreate" :editDialogOpen="editDialogOpen" 
        :editDialogClose="editDialogClose" :editDialogKeyDown="editDialogKeyDown" 
    />
</template>

<script>
    import JqxScheduler from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxscheduler.vue'
    ...
    export default {
        ...
        methods: {
            ...
            editDialogCreate: function (dialog, fields, editAppointment) {
                ...
                this.printButton = jqwidgets.createInstance('#PrintButton', 'jqxButton', {
                    width: 50,
                    height: 25
                });

                this.printButton.addEventHandler('click', function () {
