<template>
    <div>
        <JqxTabs ref="myTabs" :width="getWidth" style="float: left;">
            ...
            <div>
                The design of Scala started in 2001 at the cole Polytechnique Federale de Lausanne
...
<script>
    ...
    export default {
        ...
        methods: {
            checkedRight: function () {
                this.$refs.myTabs.scrollPosition = 'right';
            },
            checkedLeft: function () {
                this.$refs.myTabs.scrollPosition = 'left';
            },
            checkedBoth: function () {
                this.$refs.myTabs.scrollPosition = 'both';
            }
        }
    }
</script>
