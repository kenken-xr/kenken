<template>
    <JqxTabs ref="myTabs"
        ...
        <ul style="margin-left: 40px;">
            <li>
                <div style="height: 40px;">
                    <img style='float: left;' width='32' height='32' src="../../../images/building_small.jpg" alt="" class="small-image" />
            ...
            <li>
                <div style="height: 40px;">
                    <img style='float: left;' width='32' height='32' src="../../../images/building2_small.jpg" alt="" class="small-image" />
                    <div style="float: left; margin-left: 6px; text-align: center; margin-top: 5px; font-size: 13px;">
                        Burj Al Arab
                    </div>
                </div>
            ...
            <li>
                <div style="height: 40px;">
                    <img style='float: left;' width='32' height='32' src="../../../images/building3_small.jpg" alt="" class="small-image" />
                    <div style="float: left; margin-left: 6px; text-align: center; margin-top: 5px; font-size: 13px;">
                        The Willis
                        <br />
                        Tower
        ...
        <div class="content-container">
            <div style="height: 400px">
                ...
                <div class="more-text">
                    ...
                    the building's old faade onto St Mary Axe. The Exchange Hall was a celebrated fixture
        ...
        <div class="content-container">
            <div style="height: 400px">
                <img src="../../../images/building2_big.jpg" alt="" class="big-image" />
                <h3>
                    Burj Al Arab
                </h3>
                <p class="important-text">
        ...
        <div class="content-container">
            <div style="height: 400px">
                <img src="../../../images/building3_big.jpg" alt="" class="big-image" />
                <h3>
                    The Willis Tower
                </h3>
                <p class="important-text">
