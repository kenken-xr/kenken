...
<script>
    import JqxRibbon from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxribbon.vue';
    import JqxGrid from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxgrid.vue';
    import JqxButton from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxbuttons.vue';
    import JqxToggleButton from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxtogglebutton.vue';
    import JqxDropDownButton from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxdropdownbutton.vue';
    import JqxDropDownList from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxdropdownlist.vue';
    import JqxColorPicker from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxcolorpicker.vue';
    import JqxTooltip from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxtooltip.vue';
