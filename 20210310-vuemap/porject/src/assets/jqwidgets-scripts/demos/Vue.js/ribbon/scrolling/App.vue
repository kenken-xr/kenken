    ...
    <div>
        <JqxRibbon ref="myRibbon" style='float: left;'
            ...
            <div>
                ...
                <div class="contentSection">
                    <b>Lilies</b> are tall perennials ranging in height from 26 ft (60180 cm). They
                ...
                <div class="contentSection">
                    ...
                    more petals, color from white to pink, red, orange, purple or yellow, and from 418
                ...
                <div class="contentSection">
                    Flowering stalks of <b>Edelweiss</b> can grow to a size of 320 cm (in cultivation,
...
<script>
    ...
    export default {
        ...
        methods: {
            checkedNear: function () {
                this.$refs.myRibbon.scrollPosition = 'near';
            },
            checkedFar: function () {
                this.$refs.myRibbon.scrollPosition = 'far';
            },
            checkedBoth: function () {
                this.$refs.myRibbon.scrollPosition = 'both';
            }
        }
    }
</script>
