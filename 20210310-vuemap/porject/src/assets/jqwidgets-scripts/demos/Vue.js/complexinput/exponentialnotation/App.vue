...
<script>
    import JqxComplexInput from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxcomplexinput.vue";
    ...
    export default {
        ...
        methods: {
            notationsListOnChange: function (event) {
                let args = event.args;
                if (args) {
