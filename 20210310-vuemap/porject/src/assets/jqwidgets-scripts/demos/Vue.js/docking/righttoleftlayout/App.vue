<template>
    <JqxDocking :orientation='"horizontal"' :width="getWidth" :mode="'docked'" :rtl="true">
        <div>
            <div id="window1" style="height: 220px;">
                ...
                <div style="overflow: hidden;">
                    <JqxCalendar :width="180" :height="180" :rtl="true" style="float: left; margin-right: 10px;">
                    </JqxCalendar>
            ...
            <div id="window2" style="height: 220px">
                ...
                <div style="overflow: hidden;">
                    <JqxTabs :width="350" :height="181" :selectedItem="1" :rtl="true">
        ...
        <div>
            <div id="window3" style="height: 220px">
                ...
                <div style="overflow: hidden;">
                    <JqxPanel :width="'100%'" :height="180" :rtl="true">
                        <div style="padding-left: 20px;">
                            ...
                            <span style="text-align: right; direction: rtl; font-size: 12px">
            ...
            <div id="window4" style="height: 220px;">
                ...
                <div style="overflow: hidden;">
                    <JqxListBox :width="'100%'" :height="181" :source="source" :rtl="true">
                    </JqxListBox>
                </div>
            </div>
        </div>
...
<script>
    import JqxDocking from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxdocking.vue";
    import JqxCalendar from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxcalendar.vue";
    import JqxTabs from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxtabs.vue";
    import JqxPanel from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxpanel.vue";
    import JqxListBox from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxlistbox.vue";
