...
<script>
    import JqxToolbar from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxtoolbar.vue';
                ...
                switch (index) {
                    ...
                    case 4:
                        ...
                        tool.jqxDropDownList({
                            width: dropDownListWidth, selectedIndex: 1,
                            source: ["<span style='font-family: Courier New;'>Courier New</span>", "<span style='font-family: Times New Roman;'>Times New Roman</span>", "<span style='font-family: Verdana;'>Verdana</span>"]
                        });
                        break;
                    case 5:
                        let comboBoxWidth;
