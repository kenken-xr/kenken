<template>
    <JqxComboBox :width="270" :height="25" :source="dataAdapter"
                 :selectedIndex="0" :renderer="renderer" :itemHeight="70"
                 :displayMember="'firstname'" :valueMember="'valueMember'">
    </JqxComboBox>
</template>
    ...
    export default {
        ...
        beforeCreate: function () {
            ...
            const generateData = () => {
                ...
                let address = ['507 - 20th Ave. E. Apt. 2A', '908 W. Capital Way', '722 Moss Bay Blvd.', '4110 Old Redmond Rd.', '14 Garrett Hill', 'Coventry House', 'MinerRd.', 'EdgehamHollow', 'WinchesterWay', '4726-11thAve.N.E.', '7HoundstoothRd.'];
