...
<script>
    import JqxBulletChart from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxbulletchart.vue';
    ...
    import JqxSlider from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxslider.vue';
