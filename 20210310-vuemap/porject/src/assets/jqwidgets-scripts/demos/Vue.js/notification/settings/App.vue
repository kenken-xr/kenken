...
<script>
    import JqxNotification from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxnotification.vue";
    ...
    import JqxRadioButton from "src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxradiobutton.vue";
