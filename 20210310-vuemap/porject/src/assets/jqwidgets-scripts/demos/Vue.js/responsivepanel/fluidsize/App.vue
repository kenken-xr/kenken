...
<script>
    ...
    import JqxResponsivePanel from 'src/assets/jqwidgets-scripts/jqwidgets-vue/vue_jqxresponsivepanel.vue';
    ...
    export default {
        ...
        methods: {
            responsivePanelOnCollapse: function (event) {
                if (event.args.element) {
                    return;
                }
                this.$refs.myResponsivePanel.$el.style.display = 'block';
            }
        }
    }
</script>
