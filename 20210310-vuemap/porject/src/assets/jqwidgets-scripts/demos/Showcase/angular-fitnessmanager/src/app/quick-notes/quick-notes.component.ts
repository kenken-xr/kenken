...
import { jqxInputComponent } from 'src/assets/jqwidgets-scripts/jqwidgets-ts/angular_jqxinput';
import { jqxEditorComponent } from 'src/assets/jqwidgets-scripts/jqwidgets-ts/angular_jqxeditor';
...
export class QuickNotesComponent implements OnInit {
    ...
    listBoxRenderer = (index: number): string => {
        ...
        let img = '<img height="100" width="100" src=' + imgUrl + '"../../assets"/>';
