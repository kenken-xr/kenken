...
{   
    ...
    for (let i = 0; i < 10; i++)
    {
        ...
        let html = "<div style='padding: 0px; margin: 0px; height: 95px; float: left;'><img width='60' style='float: left; margin-top: 4px; margin-right: 15px;' src=" + movie + "'../../../images'/><div style='margin-top: 10px; font-size: 13px;'>"
